class Objetos {
	constructor() {
		...
		"atribuir_propriedade":{id:T_parO,parameters:[T_inteiro,T_cadeia,T_cadeia],type:T_vazio},
		"atribuir_propriedade":{id:T_parO,parameters:[T_inteiro,T_cadeia,T_caracter],type:T_vazio},
		"atribuir_propriedade":{id:T_parO,parameters:[T_inteiro,T_cadeia,T_inteiro],type:T_vazio},
		"atribuir_propriedade":{id:T_parO,parameters:[T_inteiro,T_cadeia,T_real],type:T_vazio},
		"atribuir_propriedade":{id:T_parO,parameters:[T_inteiro,T_cadeia,T_logico],type:T_vazio},
		"atribuir_propriedade":{id:T_parO,parameters:[T_inteiro,T_cadeia,T_squareO],type:T_vazio},
		"contem_propriedade":{id:T_parO,parameters:[T_inteiro,T_cadeia],type:T_logico},
		"criar_objeto":{id:T_parO,parameters:[],type:T_inteiro},
		"criar_objeto_via_json":{id:T_parO,parameters:[T_cadeia],type:T_inteiro},
		"criar_objeto_via_xml":{id:T_parO,parameters:[T_cadeia],type:T_inteiro},
		"liberar":{id:T_parO,parameters:[],type:T_vazio},
		"liberar_objeto":{id:T_parO,parameters:[T_inteiro],type:T_vazio},
		"obter_json":{id:T_parO,parameters:[T_inteiro],type:T_cadeia},
		"obter_propriedade_tipo_cadeia":{id:T_parO,parameters:[T_inteiro,T_cadeia],type:T_cadeia},
		"obter_propriedade_tipo_cadeia_em_vetor":{id:T_parO,parameters:[T_inteiro,T_cadeia,T_inteiro],type:T_cadeia},
		"obter_propriedade_tipo_caracter":{id:T_parO,parameters:[T_inteiro,T_cadeia],type:T_caracter},
		"obter_propriedade_tipo_caracter_em_vetor":{id:T_parO,parameters:[T_inteiro,T_cadeia,T_inteiro],type:T_caracter},
		"obter_propriedade_tipo_inteiro":{id:T_parO,parameters:[T_inteiro,T_cadeia],type:T_inteiro},
		"obter_propriedade_tipo_inteiro_em_vetor":{id:T_parO,parameters:[T_inteiro,T_cadeia,T_inteiro],type:T_inteiro},
		"obter_propriedade_tipo_logico":{id:T_parO,parameters:[T_inteiro,T_cadeia],type:T_logico},
		"obter_propriedade_tipo_logico_em_vetor":{id:T_parO,parameters:[T_inteiro,T_cadeia,T_inteiro],type:T_logico},
		"obter_propriedade_tipo_objeto":{id:T_parO,parameters:[T_inteiro,T_cadeia],type:T_inteiro},
		"obter_propriedade_tipo_objeto_em_vetor":{id:T_parO,parameters:[T_inteiro,T_cadeia,T_inteiro],type:T_inteiro},
		"obter_propriedade_tipo_real":{id:T_parO,parameters:[T_inteiro,T_cadeia],type:T_real},
		"obter_propriedade_tipo_real_em_vetor":{id:T_parO,parameters:[T_inteiro,T_cadeia,T_inteiro],type:T_real},
		"obter_tamanho_vetor_propriedade":{id:T_parO,parameters:[T_inteiro,T_cadeia],type:T_inteiro},
		"tipo_propriedade":{id:T_parO,parameters:[T_inteiro,T_cadeia],type:T_inteiro}
		};
