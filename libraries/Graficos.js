class Graficos {
	constructor(canvas,modal,cwindow,title)
	{
		...
		"iniciar_modo_grafico":{id:T_parO,parameters:[T_logico],type:T_vazio,jsSafe:true},
		"encerrar_modo_grafico":{id:T_parO,parameters:[],type:T_vazio,jsSafe:true},
		"definir_dimensoes_janela":{id:T_parO,parameters:[T_inteiro,T_inteiro],type:T_vazio,jsSafe:true},
		"definir_cor":{id:T_parO,parameters:[T_inteiro],type:T_vazio,jsSafe:true},
		"renderizar":{id:T_parO,parameters:[],type:T_vazio,jsSafe:false},
		"desenhar_retangulo":{id:T_parO,parameters:[T_inteiro,T_inteiro,T_inteiro,T_inteiro,T_logico,T_logico],type:T_vazio,jsSafe:true},
		"limpar":{id:T_parO,parameters:[],type:T_vazio,jsSafe:true},
		"definir_titulo_janela":{id:T_parO,parameters:[T_cadeia],type:T_vazio,jsSafe:true},
		...
		"desenhar_linha":{id:T_parO,parameters:[T_inteiro,T_inteiro,T_inteiro,T_inteiro],type:T_vazio,jsSafe:true},
		"desenhar_texto":{id:T_parO,parameters:[T_inteiro,T_inteiro,T_cadeia],type:T_vazio,jsSafe:true},
		"definir_tamanho_texto":{id:T_parO,parameters:[T_real],type:T_vazio,jsSafe:true},
		"largura_texto":{id:T_parO,parameters:[T_cadeia],type:T_inteiro,jsSafe:true},
		"altura_texto":{id:T_parO,parameters:[T_cadeia],type:T_inteiro,jsSafe:true},
		"desenhar_elipse":{id:T_parO,parameters:[T_inteiro,T_inteiro,T_inteiro,T_inteiro,T_logico],type:T_vazio,jsSafe:true},
		"entrar_modo_tela_cheia":{id:T_parO,parameters:[],type:T_vazio,jsSafe:true},
		"desenhar_poligono":{id:T_parO,parameters:[T_squareO,T_logico],type:T_vazio,jsSafe:true},
		"desenhar_ponto":{id:T_parO,parameters:[T_inteiro,T_inteiro],type:T_vazio,jsSafe:true},
		"carregar_imagem":{id:T_parO,parameters:[T_cadeia],type:T_inteiro,jsSafe:false},
		"liberar_imagem":{id:T_parO,parameters:[T_inteiro],type:T_vazio,jsSafe:true},
		"desenhar_imagem":{id:T_parO,parameters:[T_inteiro,T_inteiro,T_inteiro],type:T_vazio,jsSafe:true},
		"desenhar_porcao_imagem":{id:T_parO,parameters:[T_inteiro,T_inteiro,T_inteiro,T_inteiro,T_inteiro,T_inteiro,T_inteiro],type:T_vazio,jsSafe:true},
		
		"altura_imagem":{id:T_parO,parameters:[T_inteiro],type:T_inteiro,jsSafe:true},
		...
		"definir_gradiente":{id:T_parO,parameters:[T_inteiro,T_inteiro,T_inteiro],type:T_vazio,jsSafe:true},
		
		"definir_opacidade":{id:T_parO,parameters:[T_inteiro],type:T_vazio,jsSafe:true},
		"definir_rotacao":{id:T_parO,parameters:[T_inteiro],type:T_vazio,jsSafe:true},
